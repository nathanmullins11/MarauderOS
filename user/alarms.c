...
{
    global_time = (char*)sys_alloc_mem(100 * sizeof(char));
    global_message = (char*)sys_alloc_mem(100 * sizeof(char));
    ...
    if(!pcb_find("alarm0"))
    {
        ...
        memcpy(global_time, formatted_time, strlen(formatted_time));
        memcpy(global_message, message, strlen(message));
